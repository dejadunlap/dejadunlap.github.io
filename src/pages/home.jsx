...
export default function Home() {
    return (
      <div>
        ...
        <p>
            You can learn more about my professional experience <a href="./cv">here</a>, see some of the things that I'm working on <a href="./projects"> here</a>, or contact me <a href="./contact"> here</a>. Hope to hear from you soon!
        </p>
      </div>
    );
};